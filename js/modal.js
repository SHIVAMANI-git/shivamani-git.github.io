...
const projectsData = {
  ...
  'mobile_sec': {
    title: "Mobile Security & Android Forensics Lab",
    content: `
      <p>
      Built a controlled Android security and digital forensics lab for studying APK structure,
      application permissions, exported components, firmware metadata, and mobile forensic artifacts.
      The lab focuses on defensive analysis, secure documentation, and responsible handling of
      mobile evidence.
      </p>

      <h3>What I Analyzed</h3>
      <ul>
        <li><b>APK Metadata:</b> Reviewed package metadata, SDK compatibility, app versions, resources, and packaged assets using Apktool.</li>
        <li><b>Manifest Security:</b> Audited AndroidManifest files for permissions, exported components, intent filters, app links, providers, services, receivers, and backup/network configuration references.</li>
        <li><b>Permission Surface:</b> Reviewed sensitive permission groups such as camera, microphone, contacts, location, media access, billing, notifications, and network state.</li>
        <li><b>OTA Metadata:</b> Inspected Android update metadata for device versioning, patch level, update package size, A/B update flow, and integrity fields.</li>
        <li><b>Forensic Notes:</b> Documented findings in a structured format suitable for lab reports and evidence review.</li>
      </ul>

      <h3>Lab Environment</h3>
      <ul>
        <li><b>Primary Device:</b> OnePlus 9R running Android 14</li>
        <li><b>Static Analysis:</b> Apktool, JADX, AndroidManifest review</li>
        <li><b>Mobile Tooling:</b> ADB, Android SDK Platform Tools, MobSF, QARK</li>
        <li><b>Security Testing:</b> Frida, Objection, Wireshark in authorized lab conditions</li>
      </ul>

      <h3>Outcome</h3>
      <ul>
        <li>Built a repeatable workflow for Android APK triage and manifest security review.</li>
        <li>Created safe public summaries from raw mobile analysis artifacts.</li>
        <li>Practiced responsible handling of sensitive technical details by keeping detailed walkthroughs private.</li>
      </ul>

      <blockquote>
      Responsible Use: This lab is limited to owned devices, public sample applications, and authorized testing environments. Detailed technical steps are not published publicly.
      </blockquote>
    `
  }
};
